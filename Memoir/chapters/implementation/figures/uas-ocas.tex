\begin{figure}[htbp]
	...
	\begin{tikzpicture}
		...
		\draw[thick,decorate,decoration={coil,aspect=0,segment length=0.9cm}] (ocas) -- node[below=2mm,sloped]{MAVlink} (uav);
		\draw[thick,decorate,decoration={expanding waves,angle=6,segment length=2mm}] (ocas) -- node[below=2mm,sloped]{SSH (WiFi)} (gcs);

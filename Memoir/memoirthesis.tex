...
\fi
%
% This shit makes the subcaption package not to work
...
\usepackage{overpic}					%For overlaying several pictures
...
\usepackage{multirow}					%Multiple-rowed cells for tables
\usepackage{longtable}					%Tables spanning multiple pages
\usepackage{color}                    	%Creates coloured text and background
\usepackage[table]{xcolor}          	%Cool colorful stuff
	\definecolor{purpleAtlas}{RGB}{171,87,135}
	\rowcolors{1}{teal!10}{white}
\usepackage[]{hyperref}					%Creates hyperlinks in cross references
	\hypersetup{
		bookmarks=true,
		pdfborder={0 0 0.5 [2 3]},
		pdfstartview={FitH},
		%colorlinks=true,
...
%\usepackage[scaled=0.85]{luximono}			%Monospaced font
\usepackage{listings}					%To include source code in the document
	%\renewcommand*{\ttdefault}{lmtt}	%A better font for teletype (monospaced) family
	\lstset{
		  language=Python,
...
%\usepackage{tocloft} % Already included with the memoir class
	\newlistof{listofacronyms}{loa}{List of Acronyms}
	\newcounter{acronym}[chapter]
		%\renewcommand{\theacronym}{\arabic{acronym}}
	\newcommand{\acr}[2]{	% Defines a new acronym
		\refstepcounter{acronym}
		%\par\noindent\textbf{Answer \theacronym. #1} % Do not type anything when defining an acronym
		\addtocontents{loa}{\noindent\textbf{#1}\hspace{1cm}#2\par}
	}
...
\hyphenation{trans-fe-ring}
\hyphenation{a-vai-la-ble}
\hyphenation{rea-so-na-ble}
%
...
\addcontentsline{toc}{section}{Dedication and Acknowledgements}
\clearemptydoublepage
%
...
\begin{KeepFromToc}	% To insert with 'section' format instead of 'chapter' in Table of Contents
	\listoffigures
\end{KeepFromToc}
...
\clearemptydoublepage
%
\phantomsection\addcontentsline{toc}{section}{List of Acronyms}
\begin{KeepFromToc}	% To insert with 'section' format instead of 'chapter' in Table of Contents
...
\clearemptydoublepage
%
\import{chapters/stateArt/}{stateArt.tex}
\clearemptydoublepage
%
\import{chapters/background/}{background.tex}
\clearemptydoublepage
%
\import{chapters/problem/}{problem.tex}
\clearemptydoublepage
%
...
\clearemptydoublepage
%
\import{chapters/testing/}{testing.tex}
\clearemptydoublepage
%
...
\appendix
\import{chapters/appendices/}{network.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{ssh.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{sonar-doc.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{threads.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{logging.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{connect.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{sonar.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{control.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{auto.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{main.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{temperature.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{gui.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{interfaces.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{sonarDriver.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{ch7.tex}
\clearemptydoublepage
%
\import{chapters/appendices/}{observe.tex}
\clearemptydoublepage
%
...
% %\nocite{*}                  % Include non-cited entries too
